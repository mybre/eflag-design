export default {
  colorPrimaryBg: '#e6faff',
  // colorPrimary: '#006AFF',
  colorPrimary: '#0085d0',
  colorPrimaryBgHover: '#a3eaff',
  colorPrimaryBorder: '#77d5f7',
  colorPrimaryBorderHover: '#4bbbeb',
  colorPrimaryHover: '#23a0de',
  colorPrimaryTextHover: '#23a0de',
  colorPrimaryText: '#0085d0',
  colorPrimaryTextActive: '#0067ab',
  colorSuccess: '#0ac185',
