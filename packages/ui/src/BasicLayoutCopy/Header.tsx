...
const Header: React.FC<HeaderProps> = ({
  ...
  return (
    <div
      {...restProps}
      className={cx(styles[prefix], classNames(`${prefix}`, {
          ...
          <div className={`${prefix}-extra ${prefix}-extra-with-label`}>
            ...
            {showHelp && (
              <Dropdown overlay={helpMenu}>
                <Space className={cx(`${prefix}-extra-item`, styles[`${prefix}-extra-item`])}>
                  <BulbOutlined />
            ...
            {showLocale && (
              <span className={cx(`${prefix}-extra-item`, styles[`${prefix}-extra-item`])}>
          ...
          <div className={`${prefix}-extra`}>
            ...
            {docsPath && (
              <Tooltip title={locale.viewDocs}>
                <span
                  className={cx(`${prefix}-extra-item`, styles[`${prefix}-extra-item`])}
                  onClick={() => {
                    directTo(docsPath);
                  }}
                >
